    ...
    return (
      ...
      >
        <FontAwesome5
          ...
          style={{ width: 25 }}
        />
        <Text style={[estilos.navText, activo && { color: colores.primario }]}>
          {titulo}
        </Text>
      </TouchableOpacity>
    );
    ...
    <View style={estilos.contenedorPrincipal}>
      ...
      <View style={estilos.sidebar}>
        <View style={estilos.logoContainer}>
          ...
          <View style={estilos.badgeSaaS}>
            <Text style={estilos.badgeText}>SaaS</Text>
          </View>
        </View>
        ...
        <ScrollView style={{ flex: 1, marginTop: 20 }}>
          ...
          <MenuLink
            titulo="Clientes"
            icono="users"
            ruta="/panel-web/clientes"
          />
          <MenuLink
            titulo="Base de Datos"
            icono="database"
            ruta="/panel-web/database"
          />
          <MenuLink
            titulo="Planes"
            icono="crown"
            ruta="/panel-web/planes"
          />
        </ScrollView>
        ...
        <View style={estilos.footerSidebar}>
          <TouchableOpacity style={estilos.btnCerrarSesion} onPress={signOut}>
            ...
            <Text
              style={{ color: "#ff4444", fontWeight: "bold", marginLeft: 10 }}
            >
              Cerrar Sesión
            </Text>
          </TouchableOpacity>
...
const crearEstilos = (c: any) =>
  StyleSheet.create({
    ...
    sidebar: {
      ...
      ...Platform.select({
        web: { height: "100vh", position: "sticky", top: 0 },
      }),
    },
    logoContainer: {
      flexDirection: "row",
